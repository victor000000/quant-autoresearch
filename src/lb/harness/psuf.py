...
def cell_suffix(cfg) -> str:
    ...
    return (
        ...
        + ("" if cfg.get("features", "base") == "base" else "_fr" if cfg.get("features") == "rich" else "_ts" if cfg.get("features") == "termstruct" else "_ry" if cfg.get("features") == "realyield" else "_fx" + str(cfg.get("features")))
        + ("" if cfg.get("calibration", "isotonic") == "isotonic" else "_va" if cfg.get("calibration") == "venn_abers" else "_cb" + str(cfg.get("calibration")))
