...
| DIA | imbalance / `bgm+ker` / cdf_overlay / t.50 | 1.66 | Screen find, fully gated + HARDENED 2026-06-12 (regime-split 3.04/1.32 PASS, deflated-Calmar p=0.018 PASS). The candidate seat. **Online-proven (preds_match=1, 8e-09).** |
