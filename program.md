...
| IJR | imbalance / `bgm+ker` / cdf_overlay / t.50 | 2.51 | ⚠️ AUDITS-PASS, ONLINE-FAIL 2026-06-12: +2.09 edge, permute total-collapse, regime-split 3.03/1.92, deflated p=0.003 — AND it cross-fund-replicates the DIA mechanism. ROOT-CAUSED: isotonic plateaus (0.3961/0.5319) straddle the 0.50 threshold; raw scores sit on a step edge so any numeric drift flips trade decisions (DIA's distribution sits far from edges, hence 8e-09). The edge is real but **knife-edge-deployed — not seat-grade as-is**. Principled fix candidate: one pre-registered re-cut at t.45 (splits the plateaus; single trial). |
