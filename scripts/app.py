...
# imports at top (was mid-file in the monolith era)
from render_index import build_html, build_data            # noqa: E402
from console.data import _scan_rounds_csv, _load, KJ        # noqa: E402
from console.sections import rounds as rounds_sec           # noqa: E402  (reuse _item / SHOWN)
...
def graph_json():
    ...
    from render_causal_graph import vis_data
    k = _load(KJ, {})
...
def causal_graph():
    ...
    from render_causal_graph import standalone
    k = _load(KJ, {})
    cg = k.get("causal_graph", {}) or {}
    try:
