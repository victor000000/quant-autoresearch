...
CROWNS = [
    ("GLD", "logdollar_ker_x_regime_gmm_dd_overlay_t40_n15", 4.545),
    ("SOXX", "logdollar_ker_x_trend_scan_x_bgm_cdf_overlay_t50", 3.025),
    ("UUP", "imbalance_bgm_x_ker_cdf_overlay_t50", 1.296),
]
