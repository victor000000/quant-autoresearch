...
VALID_SIZING = ["ramp", "binary", "cdf_plain", "cdf_overlay", "dd_overlay", "longshort", "ls_cdf", "ls_overlay", "crashveto", "ddbreaker", "cond_es", "short_carry", "crashsoft", "tilt"]
...
def _validate_cfg(cfg):
    ...
    if cfg["features"] not in ("base", "rich", "termstruct", "evt", "disp", "sig", "realyield", "wangrich", "oilbasis", "regime"):
