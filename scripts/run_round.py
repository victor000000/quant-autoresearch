...
def _validate_cfg(cfg):
    ...
    if cfg.get("model", "xgb") not in ("xgb", "lgbm", "catboost", "lgbm_bag", "xgb_bag", "xgb_es100", "xgb_fixed"):
        raise ValueError(f"model {cfg.get('model')!r} must be xgb|lgbm|catboost|lgbm_bag|xgb_bag|xgb_es100|xgb_fixed")
