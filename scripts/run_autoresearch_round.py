...
VALID_AXES = ["dollar", "tick", "vol", "range", "logdollar", "entropy", "imbalance", "tickimb", "volumeimb", "fracdiff", "dc", "zcusum", "kyle", "run", "spectral"]
VALID_LABELERS = ["kmeans2stage", "tertile", "bgm", "agglomerative",  # carry disabled: QC runtime error, needs traceback to fix
                  ...
                  "trend_scan", "ker", "accel", "sharpe_scan", "mfe_mae", "revert", "turn_scan", "perment", "hmm", "always_long"]
